function [SPns,ptns,pns,iter] = e_solve_gamma_ref(SP,pt,p,gamma,e,k,SP0,pt0,p0,gamma0)
...
% AUTHOR: 
%  DRJ on 17/06/03
%  Adapted by Guillaume S�razin for use on Gamma G
%  
%==========================================================================
...
while success == 0
    ...
    [gammam, ~ ] = stp_interp([gamma(kl),gamma(ku)],[gamma(kl),gamma(ku)],[p(kl),p(ku)],pm);
    em = gammam - gamma0;
    if el*em < 0
        pu = pm;
        eu = em;
