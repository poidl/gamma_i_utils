...
ibb=backbone_index(squeeze(lon(1,:,:)),squeeze(lat(1,:,:))); % get backbone index
[irow,jcol,n_total,n_lateral,m,j_e_l,j_w_l,j_n_l,j_s_l]=matrix_ij(wet,k_east,k_west,k_north,k_south,ibb);
